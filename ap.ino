...
void handleRoot() {
  ...
  String message = "<meta http-equiv=\"refresh\" content=\"5; url=http://192.168.1.1\"> <a class=\"btn mb-3\" href=\"/setConnect/\">SET WiFi</a> <div class=\"card text-center mb-4\"> <div class=\"card-header bg-dark\">WiFi conection status</div>";
  ...
  if (WiFiMulti.run() == WL_CONNECTED) {
    message += "<div class=\"card text-center \"> <div class=\"card-header bg-dark\">blockchain.info/ticker</div> <div class=\"card-body alert-success text-center\">" + curency + "/" + crypto + "<div class=\"fw-bolder\">" + curencySymbol + " " + price + "</div>Reload after " + (timer / 1000) + " seconds...</div> </div>";
  }
